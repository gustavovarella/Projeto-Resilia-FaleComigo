...
def duvidas():
    ...
    while loop:
        ...
        if tipo == '1':
            ...
            print(f'Por gentileza Sr(a) {firstName} escolha uma modalidade de dúvidas correta!\n')
...
def sair_ou_voltar():
    ...
    if duvida == '2':
        print(f"Sr(a) {firstName}, você será redirecionado para um de nossos atendentes.")
        t.sleep(5)
        web.open('https://chat.whatsapp.com/EKxUQ5oz54jEVnM6MNu2Dk') # biblioteca
        print('A Pitch Security agradeçe o seu acesso! Volte sempre que precisar!')
        exit()
    elif duvida == '1':
        print('A Pitch Security agradeçe o seu acesso! Volte sempre que precisar!')
...
def contato():
    ...
    while loop:
        ...
        if tipo == '1':
            ...
            print(f'Por gentileza Sr(a) {firstName} escolha uma modalidade de contatos correta!\n')
        if voltar == True:
            loop = False 
...
def informacoes():
    ...
    while loop:
        ...
        if tipo == '1':
            ...
            print(f'Por gentileza Sr(a) {firstName} escolha uma modalidade de informações correta!\n')
        if voltar == True:
            loop = False
